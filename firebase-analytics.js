    ...
    try {
        (function() {
                ...
                function t(t) {
                    return function(e) {
                        return function(t) {
                            ...
                            for (; s;)
                                try {
                                    if (i = 1, o && (a = 2 & t[0] ? o.return : t[0] ? o.throw || ((a = o.return) && a.call(o), 0) : o.next) && !(a = a.call(o, t[1])).done)
                                        return a;
            ...
            var i,
                ...
                a,
                u = "FirebaseError",
                g = (i = Error, n(o = y, a = i), o.prototype = null === a ? Object.create(a) : (m.prototype = a.prototype, new m), y);
            function m() {
                this.constructor = o
            }
            function y(e, t, n) {
                t = i.call(this, t) || this;
                return t.code = e, t.customData = n, t.name = u, Object.setPrototypeOf(t, y.prototype), Error.captureStackTrace && Error.captureStackTrace(t, b.prototype.create), t
            }
            var b = (w.prototype.create = function(e) {
                ...
                var r,
                    ...
                    o = this.service + "/" + e,
                    e = this.errors[e],
                    e = e ? (r = i, e.replace(I, function(e, t) {
                        var n = r[t];
            ...
            function j(e, r, t, n) {
                n.forEach(function(n) {
                    n in t.prototype && (e.prototype[n] = function() {
                        return e = this[r], (t = P(e, n, arguments)).then(function(e) {
                            if (e)
                ...
                return h(this, void 0, void 0, function() {
                    ...
                    return v(this, function(e) {
                        ...
                        case 0:
                            return [4, r.json()];
                        case 1:
                            return t = e.sent(), t = t.error, [2, z.create("request-failed", {
                                requestName: n,
                                serverCode: t.code,
            ...
            function ee(e, t) {
                t = t.refreshToken,
                e = Q(e);
                return e.append("Authorization", K + " " + t), e
            }
            function te(n) {
                return h(this, void 0, void 0, function() {
                    var t;
            ...
            function de() {
                0 === se.size && le && (le.close(), le = null)
            }
            var pe,
                he,
                ve = "firebase-installations-database",
                ge = 1,
                ...
                return h(this, void 0, void 0, function() {
                    ...
                    return v(this, function(e) {
                        ...
                        case 0:
                            return t = ae(o), [4, be()];
                        case 1:
                            return r = e.sent(), n = r.transaction(me, "readwrite"), [4, (r = n.objectStore(me)).get(t)];
                        case 2:
                            return i = e.sent(), [4, r.put(a, t)];
                        case 3:
                            return e.sent(), [4, n.complete];
                        case 4:
                            return e.sent(), i && i.fid === a.fid || ue(o, a.fid), [2, a]
                        }
                    })
                })
            }
            ...
            function Oe(i, o) {
                return void 0 === o && (o = !1), h(this, void 0, void 0, function() {
                    var r,
                        t,
                        n;
                    return v(this, function(e) {
            ...
            function Pe(t, n) {
                return void 0 === n && (n = !1), h(this, void 0, void 0, function() {
                    return v(this, function(e) {
                        switch (e.label) {
                        case 0:
                            return [4, function(n) {
            ...
            function xe(e, r) {
                ...
                return function(e, t) {
                    fe();
                    var n = ae(e);
                    (e = se.get(n)) || (e = new Set, se.set(n, e)),
                    e.add(t)
                }(i, r), function() {
                    var e,
                        t,
                    ...
                    t = r,
                    n = ae(e = i),
                    (e = se.get(n)) && (e.delete(t), 0 === e.size && se.delete(n), de())
                }
            }
            function ke(e) {
                        ...
                        return function(r) {
                            return h(this, void 0, void 0, function() {
                                ...
                                return v(this, function(e) {
                                    ...
                                    case 1:
                                        return t = e.sent(), n = t.installationEntry, (t.registrationPromise || Oe(r)).catch(console.error), [2, n.fid]
                                    }
                                })
                            })
                        }(n)
            ...
            var Re = {
                ...
                Fe = he.INFO,
                Me = (($ = {})[he.DEBUG] = "log", $[he.VERBOSE] = "log", $[he.INFO] = "info", $[he.WARN] = "warn", $[he.ERROR] = "error", $),
                ...
                return function(n, r, i) {
                    return h(this, void 0, void 0, function() {
                        ...
                        return v(this, function(e) {
                            switch (e.label) {
                            case 0:
                                return e.trys.push([0, 6, , 7]), n !== qe.EVENT ? [3, 2] : [4, function(u, c, l, f, d) {
                                    return h(this, void 0, void 0, function() {
                                        var n,
                                            r,
                                            t,
                                        ...
                                        return v(this, function(e) {
                                            ...
                                            case 3:
                                                return e.sent(), u(qe.EVENT, f, d || {}), [3, 5];
                                            case 4:
                                                return s = e.sent(), ze.error(s), [3, 5];
                                            case 5:
                                                return [2]
                                            }
                                        })
                                    ...
                                    return h(this, void 0, void 0, function() {
                                        ...
                                        return v(this, function(e) {
                                            ...
                                            case 6:
                                                return [3, 8];
                                            case 7:
                                                return n = e.sent(), ze.error(n), [3, 8];
                                            case 8:
                            ...
                            case 5:
                                return [3, 7];
                            case 6:
                                return t = e.sent(), ze.error(t), [3, 7];
                            case 7:
                                return [2]
                            }
                        })
            ...
            function tt(s, u, c) {
                return void 0 === u && (u = Qe), h(this, void 0, void 0, function() {
                    var t,
                        n,
                        r,
                        i,
                        ...
                        a = this;
                    return v(this, function(e) {
                        if (i = s.options, t = i.appId, n = i.apiKey, r = i.measurementId, !t)
                            throw Ye.create("no-app-id");
                        if (n)
                            return i = u.getThrottleMetadata(t) || {
                                backoffCount: 0,
                                throttleEndTimeMillis: Date.now()
                            }, o = new rt, setTimeout(function() {
                                ...
                                return h(this, void 0, void 0, function() {
                                    ...
                                    return v(this, function(e) {
                                        ...
                                        case 0:
                                            ...
                                            e.label = 1;
                                        case 1:
                                            return e.trys.push([1, 3, , 4]), [4, (i = l, o = d, new Promise(function(e, t) {
                                        ...
                                        case 5:
                                            return s = e.sent(), f.deleteThrottleMetadata(t), [2, s];
                                        case 6:
                                            if (nt(r = e.sent()))
                                                return a = 503 === Number(r.customData.httpStatus) ? C(p, f.intervalMillis, Xe) : C(p, f.intervalMillis), s = {
                                                    throttleEndTimeMillis: Date.now() + a,
                                                    backoffCount: p + 1
                                                }, f.setThrottleMetadata(t, s), ze.debug("Calling attemptFetch again in " + a + " millis"), [2, u(c, s, l, f)];
                                            if (f.deleteThrottleMetadata(t), n)
            ...
            function ot(i, o, a, s, u) {
                return h(this, void 0, void 0, function() {
                    ...
                    return v(this, function(e) {
                                ...
                                return h(this, void 0, void 0, function() {
                                    ...
                                    return v(this, function(e) {
                                        ...
                                        case 2:
                                            return e.sent(), [3, 4];
                                        case 3:
                                            return t = e.sent(), ze.warn(Ye.create("indexeddb-unavailable", {
                                                errorInfo: t
                                            }).message), [2, !1];
                                        case 4:
                                            return [2, !0]
                        ...
                        case 1:
                            return r = e.sent(), t = r[0], n = r[1], u("js", new Date), (r = {})[Ke] = "firebase", r.update = !0, r = r, null != n && (r[Ge] = n), u(qe.CONFIG, t.measurementId, r), [2, t.measurementId]
                        }
                    })
                })
            }
            ...
            function vt(e, t) {
                ...
                0 < n.length && (n = n.map(function(e, t) {
                    return "(" + (t + 1) + ") " + e
                }).join(" "), n = Ye.create("invalid-analytics-context", {
                    errorInfo: n
                }), ze.warn(n.message));
                var n,
                    r,
                ...
                return pt || (function() {
                ...
                }() || (a = ft, (s = document.createElement("script")).src = $e + "?l=" + a, s.async = !0, document.head.appendChild(s)), i = ft, o = [], Array.isArray(window[i]) ? o = window[i] : window[i] = o, n = ut, a = ct, s = lt, r = ft, i = dt, o = function() {
                    for (var e = [], t = 0; t < arguments.length; t++)
                        e[t] = arguments[t];
                    window[r].push(arguments)
                }, window[i] && "function" == typeof window[i] && (o = window[i]), window[i] = Je(o, n, a, s), i = {
                    gtagCore: o,
                    wrappedGtag: window[i]
                }, st = i.wrappedGtag, at = i.gtagCore, pt = !0), ut[u] = ot(e, ct, lt, t, at), {
                    app: e,
                    ...
                    INTERNAL: {
                        delete: function() {
                            return delete ut[u], Promise.resolve()
                        }
                    }
                }
            }
