!function(e, t) {
    ...
    function d(e, t) {
        ...
        for (var r in t)
            t.hasOwnProperty(r) && (e[r] = d(e[r], t[r]));
        return e
    }
    var i = (t.prototype.wrapCallback = function(r) {
        ...
        return function(e, t) {
            ...
            "function" == typeof r && (n.promise.catch(function() {}), 1 === r.length ? r(e) : r(e, t))
        }
    }, t);
    function t() {
        var r = this;
    ...
    var k = {
        ...
        H = (Object.defineProperty(z.prototype, "logLevel", {
            ...
            for (var e = [], t = 0; t < arguments.length; t++)
                e[t] = arguments[t];
            this._userLogHandler && this._userLogHandler.apply(this, C([this, j.DEBUG], e)),
            this._logHandler.apply(this, C([this, j.DEBUG], e))
        }, z.prototype.log = function() {
            for (var e = [], t = 0; t < arguments.length; t++)
                e[t] = arguments[t];
            this._userLogHandler && this._userLogHandler.apply(this, C([this, j.VERBOSE], e)),
            this._logHandler.apply(this, C([this, j.VERBOSE], e))
        }, z.prototype.info = function() {
            for (var e = [], t = 0; t < arguments.length; t++)
                e[t] = arguments[t];
            this._userLogHandler && this._userLogHandler.apply(this, C([this, j.INFO], e)),
            this._logHandler.apply(this, C([this, j.INFO], e))
        }, z.prototype.warn = function() {
            for (var e = [], t = 0; t < arguments.length; t++)
                e[t] = arguments[t];
            this._userLogHandler && this._userLogHandler.apply(this, C([this, j.WARN], e)),
            this._logHandler.apply(this, C([this, j.WARN], e))
        }, z.prototype.error = function() {
            for (var e = [], t = 0; t < arguments.length; t++)
                e[t] = arguments[t];
            this._userLogHandler && this._userLogHandler.apply(this, C([this, j.ERROR], e)),
    ...
    function K(e, t, r) {
        ...
        this._addComponent(new I("app", function() {
            return o
        }, "PUBLIC"));
        try {
    ...
    function Z(l) {
        ...
        function o(r) {
            var t,
                ...
                i = r.name;
            if (u.has(i))
                return $.debug("There were multiple attempts to register component " + i + "."), "PUBLIC" === r.type ? p[i] : null;
            u.set(i, r),
            "PUBLIC" === r.type && (n = function(e) {
    ...
    ee.registerVersion(M, "0.6.12", te),
    ee.registerVersion("fire-js", "");
    return re.registerVersion("firebase", "8.0.0", "app"), re
});
