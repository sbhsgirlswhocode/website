    ...
    var i = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(t) {
        ...
        s = (function(t) {
            var e = "alert",
                ...
                h = function() {
                    ...
                    return e.prototype.close = function(t) {
                        ...
                        r.supportsTransitionEnd() && t(e).hasClass(l.FADE) ? t(e).one(r.TRANSITION_END, function(t) {
            ...
            var e = "button",
                ...
                l = function() {
                    ...
                    return e.prototype.toggle = function() {
                        ...
                        n && this._element.setAttribute("aria-pressed", !t(this._element).hasClass(r.ACTIVE)),
                ...
                _ = function() {
                    ...
                    return l.prototype.next = function() {
                        ...
                        var i = this,
                            ...
                            _ = void 0,
                            g = void 0;
                        if (e === u.NEXT ? (c = f.LEFT, _ = f.NEXT, g = u.LEFT) : (c = f.RIGHT, _ = f.PREV, g = u.RIGHT), a && t(a).hasClass(f.ACTIVE))
                            this._isSliding = !1;
                            ...
                            }).emulateTransitionEnd(600)) : (t(o).removeClass(f.ACTIVE), t(a).addClass(f.ACTIVE), this._isSliding = !1, t(this._element).trigger(m)),
                            h && this.cycle()
                        }
                        ...
                        return this.each(function() {
                            ...
                            if (n || (n = new l(this, o), t(this).data(s, n)), "number" == typeof e)
                                n.to(e);
                    ...
                    return a.prototype.toggle = function() {
                        ...
                        if (!this._isTransitioning && t(this._element).hasClass(u.SHOW)) {
                            ...
                            if (t(this._element).trigger(n), !n.isDefaultPrevented()) {
                                ...
                                r.supportsTransitionEnd() ? t(this._element).one(r.TRANSITION_END, l).emulateTransitionEnd(600) : l()
                            }
                        }
                            ...
                            for (var n = t.makeArray(t(d.DATA_TOGGLE)), i = 0; i < n.length; i++) {
                                ...
                                if (r) {
                                    ...
                                    if (t(o).hasClass(u.SHOW) && !(e && ("click" === e.type && /input|textarea/i.test(e.target.tagName) || "keyup" === e.type && 9 === e.which) && t.contains(o, e.target))) {
                                        ...
                                        t(o).trigger(f),
                                        f.isDefaultPrevented() || ("ontouchstart" in document.documentElement && t("body").children().off("mouseover", null, t.noop), n[i].setAttribute("aria-expanded", "false"), t(h).removeClass(u.SHOW), t(o).removeClass(u.SHOW).trigger(t.Event(c.HIDDEN, a)))
                                    }
                                }
                            }
            ...
            var e = "modal",
                ...
                u = {
                    SCROLLBAR_MaterialSURER: "modal-scrollbar-Materialsure",
                ...
                f = function() {
                    ...
                    return a.prototype.toggle = function(t) {
                        ...
                        if (!this._isTransitioning) {
                            ...
                            this._isShown || i.isDefaultPrevented() || (this._isShown = !0, this._checkScrollbar(), this._setScrollbar(), t(document.body).addClass(u.OPEN), this._setEscapeEvent(), this._setResizeEvent(), t(this._element).on(c.CLICK_DISMISS, d.DATA_DISMISS, function(t) {
                                return n.hide(t)
                        ...
                        if (e && e.preventDefault(), !this._isTransitioning && this._isShown) {
                            ...
                            this._isShown && !o.isDefaultPrevented() && (this._isShown = !1, this._setEscapeEvent(), this._setResizeEvent(), t(document).off(c.FOCUSIN), t(this._element).removeClass(u.SHOW), t(this._element).off(c.CLICK_DISMISS), t(this._dialog).off(c.MOUSEDOWN_DISMISS), i ? t(this._element).one(r.TRANSITION_END, function(t) {
                        ...
                        if (this._isShown && this._config.backdrop) {
                            ...
                            }), o && r.reflow(this._backdrop), t(this._backdrop).addClass(u.SHOW), !e)
                                return;
                            if (!o)
                                return void e();
                        ...
                        t.className = u.SCROLLBAR_MaterialSURER,
            ...
            var e = "scrollspy",
                ...
                f = function() {
                    ...
                    return s.prototype.refresh = function() {
                        ...
                        var i = t(n.join(","));
                        i.hasClass(c.DROPDOWN_ITEM) ? (i.closest(u.DROPDOWN).find(u.DROPDOWN_TOGGLE).addClass(c.ACTIVE), i.addClass(c.ACTIVE)) : (i.addClass(c.ACTIVE), i.parents(u.NAV_LIST_GROUP).prev(u.NAV_LINKS + ", " + u.LIST_ITEMS).addClass(c.ACTIVE)),
            ...
            var e = t.fn.tab,
                ...
                l = function() {
                    ...
                    return e.prototype.show = function() {
                        ...
                        l && h ? t(l).one(r.TRANSITION_END, c).emulateTransitionEnd(150) : c(),
            ...
            var e = "tooltip",
                ...
                m = function() {
                    ...
                    return a.prototype.enable = function() {
                        ...
                        o.isDefaultPrevented() || (t(i).removeClass(p.SHOW), "ontouchstart" in document.documentElement && t("body").children().off("mouseover", null, t.noop), this._activeTrigger[g.CLICK] = !1, this._activeTrigger[g.FOCUS] = !1, this._activeTrigger[g.HOVER] = !1, r.supportsTransitionEnd() && t(this.tip).hasClass(p.FADE) ? t(i).one(r.TRANSITION_END, s).emulateTransitionEnd(150) : s(), this._hoverState = "")
                        ...
                        t(n.getTipElement()).hasClass(p.SHOW) || n._hoverState === d.SHOW ? n._hoverState = d.SHOW : (clearTimeout(n._timeout), n._hoverState = d.SHOW, n.config.delay && n.config.delay.show ? n._timeout = setTimeout(function() {
                        ...
                        n._isWithActiveTrigger() || (clearTimeout(n._timeout), n._hoverState = d.OUT, n.config.delay && n.config.delay.hide ? n._timeout = setTimeout(function() {
